...
const uri = "mongodb+srv://homeservice:XIY8UkG9HASA8PvC@cluster0.kq3to.mongodb.net/?retryWrites=true&w=majority";
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });

// const uri = `mongodb+srv://utilities:kmPz9zw9V8NslKxg@cluster0.otvqo.mongodb.net/?retryWrites=true&w=majority`;
// const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });
...
async function run() {
    try {
        ...
        await client.connect();
        // console.log('database connected');
        const toolsCollection = client.db('homeService').collection('services');
        const ordersCollection = client.db('homeService').collection('orderDetails');
        const reviewCollection = client.db('homeService').collection('review');
